...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/system/build.prop)
...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/system/build.prop)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/jflte/obj/EXECUTABLES/mm-vdec-omx-test*_intermediates)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/symbols/system/bin/mm-vdec-omx-test*)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/system/bin/mm-vdec-omx-test*)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/jflte/obj/EXECUTABLES/charger_touch_intermediates)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/symbols/system/bin/charger_touch)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/system/bin/charger_touch)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/obj/NOTICE_FILES/src/system/bin/charger_touch.txt)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/jflte/root/default.prop)
